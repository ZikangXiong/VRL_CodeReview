...
# Last Modified time: 2019-02-12 11:46:29
# -------------------------------
import sys
sys.path.append("../../")
...
def selfdrive(learning_method, number_of_rollouts, simulation_steps, learning_eposides, critic_structure, actor_structure, train_dir, K=None):
  ...
  shield_path = ["deg"+str(i)+"/" for i in range(4, 10, 2)]
  for sp in shield_path:
    model_path = os.path.split(args['model_path'])[0]+'/'+sp
    linear_func_model_name = 'K.model'
    model_path = model_path+linear_func_model_name+'.npy'
    shield = Shield(env, actor, model_path=model_path, force_learning=False)
    shield.train_shield(learning_method, number_of_rollouts, simulation_steps, rewardf=rewardf, explore_mag=1.0, step_size=1.0, degree=4)
    shield.test_shield(500, 5000)
...
if __name__ == "__main__":
  ...
  selfdrive("random_search", 100, 500, 0, [64, 64], [64, 64], "selfdriving_obs/64646464/")