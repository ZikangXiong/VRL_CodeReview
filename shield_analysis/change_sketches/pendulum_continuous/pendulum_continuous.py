...
# Last Modified time: 2019-02-12 16:38:53
# -------------------------------
import sys
sys.path.append("../../")
...
def pendulum(learning_method, number_of_rollouts, simulation_steps, learning_eposides, critic_structure, actor_structure, train_dir):
  ...
  #   shield.train_shield(learning_method, number_of_rollouts, simulation_steps, rewardf=rewardf, eq_err=0, explore_mag = 1.0, step_size = 1.0, degree=5)
...
if __name__ == "__main__":
  ...
  pendulum("random_search", 100, 200, 0, [240,200], [280,240,200], "pendulum_continuous/240200280240200/") 
