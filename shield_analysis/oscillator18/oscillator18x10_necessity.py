...
#  fail_list = read_scan("oscillator18/oscillator18x10.log_fis_ret.pkl")
#  shield.test_shield(x0_list=fail_list[:10], test_step=1000)
#  success_list = read_scan("oscillator18/oscillator18.log_sis_ret.pkl")
#  test_necessity_extension(shield, fail_list, success_list)


  shield_list = read_scan("oscillator18/oscx10_fail_shield_mini.log_ss_ret.pkl")
  print shield_list[:10]
